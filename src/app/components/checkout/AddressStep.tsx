    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <Card className="border-2 border-[#D4AF37] bg-[#D4AF37]/5 relative cursor-pointer">
                    <div className="absolute top-4 right-4 bg-[#D4AF37] text-white text-xs px-2 py-1 rounded">DEFAULT</div>
                    <CardContent className="p-4">
                        ...
                        <div className="mt-4 pt-4 border-t flex justify-end">
                            <Button size="sm" onClick={handleSubmit} className="bg-[#D4AF37] hover:bg-[#C19B2A] text-white">
                                Deliver Here
                            </Button>
                        </div>
                    </CardContent>
            ...
            <div className="flex justify-end">
                <Button type="submit" form="address-form" size="lg" className="bg-[#D4AF37] hover:bg-[#C19B2A] text-white px-8">
                    Save and Continue
                </Button>
            </div>
        </div>
