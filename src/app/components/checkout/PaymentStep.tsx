            ...
            <Card>
                ...
                <CardContent>
                    <RadioGroup value={paymentMethod} onValueChange={(val: string) => {
                        ...
                        <div className={`flex items-center space-x-4 p-4 rounded-lg border-2 cursor-pointer transition-all ${paymentMethod === 'razorpay' ? 'border-[#D4AF37] bg-yellow-50' : 'border-gray-200'}`}>
                            <RadioGroupItem value="razorpay" id="razorpay" className="text-[#D4AF37]" />
                        ...
                        <div className={`flex items-center space-x-4 p-4 rounded-lg border-2 cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-[#D4AF37] bg-yellow-50' : 'border-gray-200'}`}>
                            <RadioGroupItem value="cod" id="cod" className="text-[#D4AF37]" />
            ...
            <div className="flex items-center justify-between pt-4">
                ...
                {paymentMethod === 'razorpay' ? (
                    <RazorpayButton
                        ...
                        className="bg-[#D4AF37] hover:bg-[#C19B2A] text-white px-8 py-6 text-lg rounded-full shadow-lg min-w-[200px]"
                    >
