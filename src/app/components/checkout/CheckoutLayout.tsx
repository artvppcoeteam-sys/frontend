            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                <div className="max-w-3xl mx-auto mb-12">
                    <div className="flex items-center justify-between relative">
                        ...
                        <div
                            className="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-[#D4AF37] transition-all duration-500 -z-10"
                            style={{
                      ...
                      ${status === 'completed' ? 'bg-[#D4AF37] border-[#D4AF37] text-white' :
                                                status === 'current' ? 'bg-white border-[#D4AF37] text-[#D4AF37] shadow-[0_0_15px_rgba(212,175,55,0.4)]' :
